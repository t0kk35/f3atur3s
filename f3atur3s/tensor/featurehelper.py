...
class FeatureHelper:
    ...
    def filter_feature(cls, feature_class: Type[T], features: List[Feature]) -> List[T]:
        """
        Class method to filter a list of dataframebuilder. The method will return the dataframebuilder from the input
        that match the current class

        Args:
            feature_class: (Type) A feature class to filter.
            features: (List of Feature) A list of dataframebuilder.

        Returns:
            A list of dataframebuilder. Contains the input dataframebuilder that are of the class of feature_class.
        """
    ...
    def filter_not_feature(cls, feature_class: Type[Feature], features: List[T]) -> List[T]:
        ...
        Args:
            feature_class (Type) A feature class to filter.
            features: A list of dataframebuilder.

        Returns:
             A list of dataframebuilder. Contains the input dataframebuilder that are not of the class feature_class
        """
    ...
    def filter_feature_type(cls, feature_type: Type[FeatureType], features: List[T]) -> List[T]:
        ...
        Returns:
             A list of dataframebuilder. Contains the input dataframebuilder that are of the type of the current class
        """
